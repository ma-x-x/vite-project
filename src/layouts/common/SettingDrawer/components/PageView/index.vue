<template>
	...
	<n-space vertical size="large">
		...
		<setting-menu label="多页签风格">
			<n-select class="w-120px" size="small" :value="theme.tab.mode" :options="theme.tab.modeList"
		...
		<setting-menu label="页面切换动画类型">
			<n-select class="w-120px" size="small" :value="theme.page.animateMode" :options="theme.page.animateModeList"
